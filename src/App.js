...
// // Floating circle animation variant
...
// // Simple rotating 3D box for hero section
...
//       <meshStandardMaterial color="#0D47A1" /> {/* Blue */}
//     </mesh>
//   );
// }
...
//     // Loads the tsparticles package with all features
...
//   // Contact form state & submission handling
...
//     emailjs
//       .sendForm(
//         "service_i6dqi68", // replace with your EmailJS service ID
//         "template_mrty8sn", // replace with your EmailJS template ID
//         e.target,
//         "bqXMM_OmpPWcc1AMi" // replace with your EmailJS public key
//       )
//       .then(() => {
...
//   const [showProjectArrows, setShowProjectArrows] = useState(false);

//   const scrollProjects = (direction) => {
//     if (!projectsRef.current) return;
//     const scrollAmount = projectsRef.current.clientWidth * 0.5 + 16; // half container width + gap
//     if (direction === "left") {
...
//       desc: "End-to-end React and FastAPI app that delivers stock data, news, and AI insights for smarter investment decisions.",
//       tech: "React, Node.js, LangChain, OpenAI",
//       liveLink: "https://stock-market-copilot.vercel.app/",
//       githubLink: "https://github.com/meetgojiya98/Stock-Market-Copilot",
//     },
//     {
//       title: "Stock Sentiment Dashboard",
//       desc: "The app provides a real-time dashboard displaying stock market sentiment, trending stocks, latest news, and Reddit posts to help users track market mood and insights.",
//       tech: "React, TailwindCSS, Framer Motion, Three.js",
//       liveLink: "https://meetgojiya98.github.io/stock-sentiment-frontend/",
//       githubLink: "https://github.com/meetgojiya98/Stock-Sentiment-Dashboard",
//     },
//     {
//       title: "Coming soon...",
//       desc: "",
//       tech: "",
//       liveLink: "https://meetgojiya.com",
//       githubLink: "https://github.com/meetgojiya/portfolio",
//     },
//   ];
...
//         }
//         /* Hide scrollbar for projects container on Firefox */
//         .no-scrollbar {
...
//       <div className="font-sans min-h-screen overflow-x-hidden bg-white text-black transition-colors duration-500">
//         {/* Navbar */}
//         <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 shadow-md bg-black bg-opacity-90 backdrop-blur-md">
//           <div
...
//           <div className="hidden md:flex space-x-8 text-lg font-semibold cursor-pointer text-white">
...
//             fpsLimit: 60,
//             particles: {
//               color: { value: ["#FF9933", "#0D47A1", "#000000"] },
//               links: {
//                 enable: true,
//                 distance: 150,
//                 color: "#FF9933",
...
//         <section
//           id="hero"
//           className="relative flex flex-col items-center justify-center min-h-screen px-6 text-center overflow-hidden pt-20"
//         >
//           {/* Floating circles */}
//           <motion.div
//             variants={floatingCircleVariants}
//             animate="float"
//             className="absolute top-10 left-10 w-40 h-40 rounded-full bg-[#FF9933] opacity-70 filter blur-3xl"
//           />
//           <motion.div
//             variants={floatingCircleVariants}
//             animate="float"
//             transition={{ delay: 1, duration: 8, yoyo: Infinity }}
//             className="absolute bottom-20 right-10 w-56 h-56 rounded-full bg-[#0D47A1] opacity-60 filter blur-2xl"
//           />

//           {/* 3D box */}
//           <div className="absolute -bottom-40 right-0 w-72 h-72 md:w-96 md:h-96 pointer-events-none z-10">
...
//             className="relative text-5xl md:text-7xl font-extrabold drop-shadow-lg max-w-4xl z-20"
//             style={{ color: "#FF9933" }}
//           >
//             Hi, I'm Meet Gojiya
//           </motion.h1>
...
//             className="mt-6 max-w-xl text-lg md:text-xl z-20"
//             style={{ color: "#000000" }}
//           >
//             Full-stack Developer | AI Enthusiast | Software Engineer with a passion for beautiful, interactive experiences.
//           </motion.p>

//           <motion.button
//             whileHover={{ scale: 1.1 }}
//             whileTap={{ scale: 0.95 }}
//             className="mt-10 px-10 py-4 rounded-full font-bold shadow-lg transition-transform duration-300 relative overflow-hidden z-20"
...
//         {/* About */}
//         <section id="about" className="py-20 px-6 md:px-20 max-w-4xl mx-auto text-black">
//           <motion.h2
//             initial="hidden"
//             whileInView="visible"
//             viewport={{ once: true }}
...
//         <section
//           id="projects"
//           className="py-20 px-6 md:px-20 max-w-6xl mx-auto text-black relative"
//           ref={projectsContainerRef}
//           onMouseEnter={() => setShowProjectArrows(true)}
//           onMouseLeave={() => setShowProjectArrows(false)}
//         >
//           <h2 className="text-4xl font-extrabold mb-14 text-center" style={{ color: "#FF9933" }}>
//             Projects
//           </h2>
...
//               className="absolute top-1/2 left-0 -translate-y-1/2 bg-[#FF9933] text-black rounded-r px-3 py-2 shadow-lg hover:bg-[#e68a00] transition-colors z-20"
//             >
//               &#8592;
//             </button>
//           )}
...
//           <div
//             ref={projectsRef}
//             className="flex overflow-x-auto gap-6 scroll-smooth pb-4 no-scrollbar"
//             style={{
...
//             }}
//           >
//             {projects.map(({ title, desc, tech, liveLink, githubLink }, i) => (
//               <motion.div
//                 key={i}
//                 initial="hidden"
//                 whileInView="visible"
...
//                 onKeyDown={(e) => {
//                   if (e.key === "Enter") {
//                     window.open(liveLink || githubLink, "_blank");
//                   }
//                 }}
//                 className="bg-white bg-opacity-90 rounded-3xl p-8 shadow-lg cursor-pointer transition-transform duration-300 hover:scale-105 hover:shadow-2xl flex flex-col justify-between flex-shrink-0"
//                 style={{
...
//                   <p className="italic text-sm text-gray-700">{tech}</p>
//                 </div>
...
//               className="absolute top-1/2 right-0 -translate-y-1/2 bg-[#FF9933] text-black rounded-l px-3 py-2 shadow-lg hover:bg-[#e68a00] transition-colors z-20"
//             >
//               &#8594;
//             </button>
//           )}
...
//         {/* Skills */}
//         <section id="skills" className="py-20 px-6 md:px-20 max-w-4xl mx-auto text-black">
//           <h2 className="text-4xl font-extrabold mb-12 text-center" style={{ color: "#FF9933" }}>
//             Skills
//           </h2>
//           <div className="max-h-72 overflow-y-auto custom-scrollbar p-4 rounded-lg">
...
//                   className="p-6 rounded-xl shadow-md cursor-default select-none transition-transform duration-300 hover:scale-110"
//                   style={{
//                     backgroundColor: i % 2 === 0 ? "#FF9933" : "#0D47A1",
//                     color: "#FFFFFF",
//                   }}
//                 >
//                   {skill}
...
//         {/* Contact */}
//         <section id="contact" className="py-20 px-6 md:px-20 max-w-3xl mx-auto text-black">
//           <h2 className="text-4xl font-extrabold mb-10 text-center" style={{ color: "#FF9933" }}>
//             Contact Me
//           </h2>
...
//               className="px-4 py-3 rounded-lg border border-gray-300 text-black focus:outline-none focus:ring-2 focus:ring-[#FF9933]"
//             />
//             <input
//               required
//               type="email"
...
//               className="px-4 py-3 rounded-lg border border-gray-300 resize-none text-black focus:outline-none focus:ring-2 focus:ring-[#FF9933]"
//             />
//             <button
//               type="submit"
//               className="py-3 rounded-lg font-semibold transition-colors duration-300"
//               style={{ backgroundColor: "#0D47A1", color: "#FFFFFF" }}
//             >
//               Send Message
//             </button>
...
//               style={{ color: formStatus.includes("successfully") ? "green" : "red" }}
//             >
//               {formStatus}
//             </p>
//           )}
...
//           <button
//             className="bg-[#FF9933] text-black font-semibold px-6 py-3 rounded-full shadow-lg hover:bg-[#e68a00] transition-colors"
//             onClick={() => {
//               window.open(
//                 "https://drive.google.com/file/d/1_4e5xp2ZGU1E4WiWoKyaRWIWRe7z2gVI/view?usp=sharing",
//                 "_blank"
//               );
//             }}
//           >
...
//         {/* Footer */}
//         <footer className="py-8 text-center text-sm bg-black text-white">
//           © 2025 Meet Gojiya. All rights reserved.
//         </footer>
//       </div>
//     </>
//   );
...
export default function App() {
  ...
  return (
    ...
    >
      ...
      <a
        href="https://drive.google.com/file/d/1_4e5xp2ZGU1E4WiWoKyaRWIWRe7z2gVI/view?usp=sharing" // update with your resume file location
        target="_blank"
        rel="noopener noreferrer"
